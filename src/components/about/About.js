        ...
        {/* <div> */}
          <div className="ab-text-wrapper">
            <div className="ab-text-box">
              <p className="ab-text">
                ...
                regarding how they want their assets distributed among their
                loved ones
              </p>
            </div>
          </div>
          <div className="ab-text-box">
            <p className="ab-text">
              ...
              executed in accordance with applicable laws so that your will is
          ...
          <div className="ab-text-box">
            <p className="ab-text">
              ...
              unable to manage your financial affairs on your own. We can also
              prepare the Power of Attorney, Health Care Proxy, Living Will,
              Self-Proving Affidavit, Trust Agreement and related documents.
            </p>
          </div>
        {/* </div> */}
      </div>
